...
//     let dbRoles = await getAllRole();
//     inputRoles.innerHTML = `
//             <option value="${dbRoles[0].id}">${dbRoles[0].role.substring(5)}</option>
//             <option value="${dbRoles[1].id}">${dbRoles[1].role.substring(5)}</option>
//             `
// }
